...
public abstract class EaseChatRow extends LinearLayout {
    ...
    protected RoundImageView userAvatarView;
    ...
    private void initView() {
        ...
        userAvatarView = (RoundImageView) findViewById(R.id.iv_userhead);
        ...
        if (userAvatarView != null) {
            userAvatarView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (itemClickListener != null) {
                        if (message.direct() == Direct.SEND) {
                            itemClickListener.onUserAvatarClick(EMClient.getInstance().getCurrentUser(), message.getFrom());
                        } else {
                            itemClickListener.onUserAvatarClick(message.getFrom(), message.getFrom());
                        }
                    }
                }
            });
