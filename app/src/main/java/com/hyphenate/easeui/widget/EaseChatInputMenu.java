...
public class EaseChatInputMenu extends LinearLayout {
    ...
    public static EaseChatPrimaryMenuBase chatspace;
    ...
    public void init(List<EaseEmojiconGroupEntity> emojiconGroupList) {
        ...
        if (chatPrimaryMenu == null) {
            ...
            chatspace = (EaseChatPrimaryMenu) layoutInflater.inflate(R.layout.ease_layout_chat_primary_menu, null);
        }
        ...
        if (emojiconMenu == null) {
            ...
            if (emojiconGroupList == null) {
                ...
                emojiconGroupList.add(new EaseEmojiconGroupEntity(R.drawable.ee_one, Arrays.asList(EaseDefaultEmojiconDatas.getData())));
            }
