...
import com.lsjr.zizisteward.ly.activity.GanapatiDataActivity;
import com.lsjr.zizisteward.ly.activity.NetworkInformationActivity;
...
public class EaseChatFragment extends EaseBaseFragment implements
    ...
    public static EaseChatInputMenu inputMenu;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (chatType != EaseConstant.CHATTYPE_SINGLE) {
            Groupid = fragmentArgs.getString("Groupid");
            Groupmin = fragmentArgs.getString("Groupmin");
            Groupmax = fragmentArgs.getString("Groupmax");
            Groupname = fragmentArgs.getString("Groupname");
            Groupisopen = fragmentArgs.getString("Groupisopen");
            Groupisowner = fragmentArgs.getString("Groupisowner");
            Groupdescription = fragmentArgs.getString("Groupdescription");
            New_Topic_Old_Style.refreshData();
        } else {
            if (null != MainActivity.unreadLabel) {
                Fragment_ChatList.refreshData();
            }
            nike = fragmentArgs.getString("nike");
        }
    ...
    protected void initView() {
        ...
        inputMenu.setChatInputMenuListener(new ChatInputMenuListener() {
            ...
            public void onSendMessage(String content) {
                ...
                if (App.getUserInfo().getGname().equals(toChatUsername)) {
                    map.put("OPT", "217");
                    map.put("steward_id", App.getUserInfo().getGmid());
                    map.put("user_id", Fragment_ChatList.addSign(Long.valueOf(App
                            .getUserInfo().getId()), "u"));
                    map.put("from_user_id",
                            App.getUserInfo().getId());
                    map.put("to_user_id",
                            App.getUserInfo().getGmid());
                    map.put("messageTime", str);
                    map.put("sign", "send");
                    map.put("post_messages", msg);
                    new HttpClientGet(getActivity(), null, map, false, new HttpClientGet.CallBacks<String>() {

                        @Override
                        public void onSuccess(String result) {
                            System.out.println("保存用户发送的消息: " + result);
                        }
...
//		if (toChatUsername.equals(App.getUserInfo().getGname())) {
//			titleBar.setTitle("孜孜管家");
//		}
//		} else {
        ...
        titleBar.setRightLayoutClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (chatType == Constant.CHATTYPE_GROUP) {
                    if (Groupisowner.equals("0")) {
                        startActivityForResult(
                                new Intent(getActivity(),
                                        NetworkInformationActivity.class)
                                        .putExtra("activity", "CHAT")
                                        .putExtra("Groupname", Groupname)
                                        .putExtra("Groupmin", Groupmin)
                                        .putExtra("Groupmax", Groupmax)
                                        .putExtra("Groupid", Groupid)
                                        .putExtra("Groupisopen", Groupisopen)
                                        .putExtra("Groupisowner", Groupisowner)
                                        .putExtra("Groupdescription",
                                                Groupdescription), 7);
                    } else {
                        startActivityForResult(
                                new Intent(getActivity(),
                                        GanapatiDataActivity.class)
                                        .putExtra("activity", "BOSS")
                                        .putExtra("Groupname", Groupname)
                                        .putExtra("Groupmin", Groupmin)
                                        .putExtra("Groupmax", Groupmax)
                                        .putExtra("Groupid", Groupid)
        ...
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {
            ...
            if (EaseUserUtils.getUserInfo(toChatUsername) != null) {
                ...
                if (toChatUsername.equals(
                    ...
                    //titleBar.setTitle("孜孜管家");
                    titleBar.setTitle(nike);
                } else {

                    if (null != nike && nike.length() > 0) {
                        titleBar.setTitle(nike);
                    } else {
...
//								.getNick());
            ...
            titleBar.setRightImageResource(R.drawable.icon_set);
                ...
                .setItemClickListener(new EaseChatMessageList.MessageListItemClickListener() {
                    ...
                    public void onUserAvatarClick(String username,
                        ...
                        if (chatFragmentHelper != null) {
                            chatFragmentHelper.onAvatarClick(username, account);
                        }
                    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == REQUEST_CODE_CAMERA) { // capture new image
                ...
                sendImageMessage(ChatFragment.path);
    ...
    public void onDestroy() {
         ...
         * (Context.INPUT_METHOD_SERVICE); //得到InputMethodManager的实例 if
         * (imm.isActive()) { //如果开启
         * imm.toggleSoftInput(InputMethodManager.SHOW_IMPLICIT,
         * InputMethodManager.HIDE_NOT_ALWAYS); //关闭软键盘，开启方法相同，这个方法是切换开启与关闭状态的 }
         */
        super.onDestroy();
        ...
        public void onClick(int itemId, View view) {
            ...
            switch (itemId) {
                ...
                case ITEM_PICTURE:
                    ...
                    break;
                /**
                 * case ITEM_LOCATION: startActivityForResult(new
                 * Intent(getActivity(), EaseBaiduMapActivity.class),
                 * REQUEST_CODE_MAP); break;
                 */
    ...
    protected void selectPicFromCamera() {
         ...
         * + ".jpg"); cameraFile.getParentFile().mkdirs();
         */
        /**
        ...
        ChatFragment.path = cameraFile.getPath();
        Uri uri = Uri.fromFile(cameraFile);
        System.out.println(cameraFile.getPath());
    ...
    public interface EaseChatFragmentHelper {
         ...
         * @param username
         */
        void onAvatarClick(String username, String account);
