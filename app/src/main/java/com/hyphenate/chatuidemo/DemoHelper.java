...
public class DemoHelper {
    ...
    private static Map<String, RobotUser> robotList;

    private static UserProfileManager userProManager;

    private static DemoHelper instance = null;

    private static DemoModel demoModel = null;
    ...
    public void init(Context context) {
        ...
        if (EaseUI.getInstance().init(context, options)) {
            ...
            EMClient.getInstance().callManager().getVideoCallHelper()
                    .setAdaptiveVideoFlag(getModel().isAdaptiveVideoEncode());
    ...
    public static Map<String, RobotUser> getRobotList() {
