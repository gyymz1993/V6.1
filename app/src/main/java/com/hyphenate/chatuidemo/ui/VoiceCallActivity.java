...
public class VoiceCallActivity extends CallActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.ll_mute = (LinearLayout) super.findViewById(R.id.ll_mute);
		this.ll_handsfree = (LinearLayout) super.findViewById(R.id.ll_handsfree);
		this.ll_come = (LinearLayout) super.findViewById(R.id.ll_come);
		...
		if (!isInComingCall) {// outgoing call
			...
			ll_come.setVisibility(View.VISIBLE);
                ...
                case ACCEPTED:
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            ll_handsfree.setVisibility(View.VISIBLE);
