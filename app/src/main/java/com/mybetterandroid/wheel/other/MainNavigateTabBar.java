...
/**
 * User:Shine Date:2015-10-29 Description:
 */
public class MainNavigateTabBar extends LinearLayout implements View.OnClickListener {
	...
	public MainNavigateTabBar(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		ColorStateList selectedTabTextColor = typedArray
				.getColorStateList(R.styleable.MainNavigateTabBar_navigateTabSelectedTextColor);
		...
		mNormalTextColor = (tabTextColor != null ? tabTextColor
				: context.getResources().getColorStateList(R.color.bg_red));
		...
		if (selectedTabTextColor != null) {
			...
			context.getTheme().resolveAttribute(R.attr.border_color, typedValue, true);
