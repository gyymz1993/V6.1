...
public class EyeCollectActivity extends Activity implements OnClickListener {
    private RelativeLayout mRe_share;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eye_collect);
        mRe_share = (RelativeLayout) findViewById(R.id.re_share);
        mRe_back = (RelativeLayout) findViewById(R.id.re_back);

        mRe_select_xia = (RelativeLayout) findViewById(R.id.re_select_xia);// 收起
        mRe_select_shang = (RelativeLayout) findViewById(R.id.re_select_shang);// 展开
        mTv_name = (TextView) findViewById(R.id.tv_name);// 类别
        mRe_all = (RelativeLayout) findViewById(R.id.re_all);// 选中全部
        mTv_week = (TextView) findViewById(R.id.tv_week);// 选中一周
        mTv_month = (TextView) findViewById(R.id.tv_month);// 选中一月
        mTv_three_months = (TextView) findViewById(R.id.tv_three_months);// 选中三月
        mTv_disabled = (TextView) findViewById(R.id.tv_disabled);// 选中已失效
        mListview_shijie = (SuperListView) findViewById(R.id.listview_shijie);
        mRe_null = (RelativeLayout) findViewById(R.id.re_null);// 无视界

        // 动态注册广播接收者
        IntentFilter intentFilter = new IntentFilter();
        intentFilter.addAction("action.collect");
    ...
    private BroadcastReceiver refreshList = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals("action.collect")) {
                getData(0);
                mAdapter.notifyDataSetChanged();
            }
        }
    ...
    private void initView() {
        mAdapter = new MyCollectAdapter(EyeCollectActivity.this, list);
    ...
    private void initListener() {
        mRe_select_xia.setVisibility(View.VISIBLE);
        mRe_select_shang.setVisibility(View.GONE);
        mRe_share.setOnClickListener(this);
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            mHolder.mIv_delete.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    final Dialog dialog = new Dialog(EyeCollectActivity.this, R.style.dialog);
                    ...
                    ((TextView) dialog.findViewById(R.id.tv_confirm)).setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            map.put("user_id", EncryptUtils.addSign(Integer.parseInt(App.getUserInfo().getId()), "u"));
                            new HttpClientGet(EyeCollectActivity.this, null, map, false,
                                    new HttpClientGet.CallBacks<String>() {
                                        ...
                                        public void onSuccess(String result) {
                                            ...
                                            Toast.makeText(EyeCollectActivity.this, bean.getMsg(), Toast.LENGTH_SHORT)
                                                    .show();
                                            // // 发送广播
                                            Intent intent = new Intent();
                                            intent.setAction("action.collect");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.re_select_shang:
                ...
                break;
            case R.id.re_share:
                Intent intent = new Intent(getApplicationContext(), ShareCollectActivity.class);
                startActivity(intent);
                overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                finish();
                break;
