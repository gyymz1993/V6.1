...
public abstract class ProjectYinLianPayActivity extends Activity implements Callback, Runnable {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIndentNo = intent.getStringExtra("intentNo");// 服务号
        mTransflow_type = intent.getStringExtra("transflow_type");
        mTspid = intent.getStringExtra("tspid");// 服务id
        System.out.println("流水号类型   " + mTransflow_type + " 订单号   " + mIndentNo + " 价格   " + mPrice);
        ...
        builder.setNegativeButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if ("支付成功".equals(msg)) {
                    ...
                    StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                            new Response.Listener<String>() {
                                ...
                                public void onResponse(String response) {
                                    ...
                                    System.out.println("自己返回结果" + response);
                                    ...
                                    Intent intent = getIntent();
                                    ProjectYinLianPayActivity.this.setResult(33, intent);
                    ...
                    Toast.makeText(ProjectYinLianPayActivity.this, "支付失败", Toast.LENGTH_SHORT).show();
                    finish();
