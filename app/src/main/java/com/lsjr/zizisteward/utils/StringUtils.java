...
public class StringUtils {
	...
	/************ 格式化公用方法begin ******/
	public static String getStringFormatValue(Context context, int res,
			Object... value) {
...
/**
	...
	public static int checkPwd(String pwd) {
		...
		return checkInfo(pwd);
	}

	/**
	 * 判断是否有特殊字符
	 */
	public static int checkInfo(String data) {

		for (int i = 0; i < data.length(); i++) {
			boolean b2 = Pattern.matches("\\p{Punct}", ("" + data.charAt(i))); // 判断特殊字符
			if (b2) {
				return 2;
			}
		}
