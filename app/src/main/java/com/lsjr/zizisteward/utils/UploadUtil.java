...
import com.lsjr.zizisteward.ly.activity.ActivityChoosePicture;
import com.lsjr.zizisteward.ly.activity.BuySomeGroupInformationActivity;
	...
	public void uploadFile(String[] filePath, String fileKey, String RequestURL,
		...
		try {
			...
			for (int i = 0; i < filePath.length; i++) {
				File file2 = new File(filePath[i]);
				file[i] = file2;
			}
...
//			dos.write(tempOutputStream.toByteArray());
			...
			if (res == 200) {
				...
				if ( space == 1) {
					...
					if (null != New_Topic_Old_Style.context) {
						New_Topic_Old_Style.CreateData();
					}

					BuySomeGroupInformationActivity.dis();
				}else if ( space == 2) {
					UploadUtil.space = 0;

					ActivityChoosePicture.dis();
				}
				return;
			} else {
