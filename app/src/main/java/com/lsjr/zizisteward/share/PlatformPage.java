...
package com.lsjr.zizisteward.share;
...
public abstract class PlatformPage extends OnekeySharePage {
	...
	public void onCreate() {
		...
		button2.setBackgroundColor(Color.parseColor("#CCEED0"));
		lp22.gravity = Gravity.CENTER_VERTICAL;
		...
		button.addView(button2, lp22);
		llPanel.addView(button, lp);
	}
