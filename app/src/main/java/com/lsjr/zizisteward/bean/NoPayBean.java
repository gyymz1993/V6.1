...
public class NoPayBean {
	...
	public NoPayPage getShop_indent() {
		return shop_indent;
	}

	public void setShop_indent(NoPayPage shop_indent) {
	...
	public class NoPayPage {

		private String currPage;
		private List<NoPayDetail> page;
		...
		public List<NoPayDetail> getPage() {
			return page;
		}

		public void setPage(List<NoPayDetail> page) {
			this.page = page;
		}
