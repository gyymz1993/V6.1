...
public class AllOrderBean {
	...
	public PageBean getShop_indent() {
		return shop_indent;
	}

	public void setShop_indent(PageBean shop_indent) {
	...
	public class PageBean {
		...
		private List<MyOrderDetail> page;
		...
		public List<MyOrderDetail> getPage() {
			return page;
		}

		public void setPage(List<MyOrderDetail> page) {
			this.page = page;
		}
