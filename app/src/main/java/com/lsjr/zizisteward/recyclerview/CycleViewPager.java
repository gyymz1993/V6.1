package com.lsjr.zizisteward.recyclerview;
...
public class CycleViewPager extends Fragment implements OnPageChangeListener {
    ...
    private List<NewHomeFragment.Advertisements> infos;
    ...
    public void setData(List<ImageView> views, List<NewHomeFragment.Advertisements> list, ImageCycleViewListener listener) {
     ...
     */
    public void setData(List<ImageView> views, List<NewHomeFragment.Advertisements> list, ImageCycleViewListener listener, int showPosition) {
    ...
    public static interface ImageCycleViewListener {
         ...
         * 单击图片事件
         */
        public void onImageClick(NewHomeFragment.Advertisements info, int postion, View imageView);
    }
}